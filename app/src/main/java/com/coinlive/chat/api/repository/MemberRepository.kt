...
object MemberRepository {
    ...
    fun isAvailableNickName(nickName:String) : String {
        ...
        if(!response.isSuccess() && response.d == null){
            throw RequestFailException("MemberRepository.isAvailableNickName fail. please check nickName",
    ...
    fun setNickName(nickName:String,auth:String) : String {
        ...
        if(!response.isSuccess() && response.d == null){
            throw RequestFailException("MemberRepository.setNickName fail. please check nickName or auth",
                response.code,response.msg)
        }
    ...
    fun signupCheck(firebaseUuid:String) : MemberSignupCheck {
        ...
        if(!response.isSuccess() && response.d == null){
            throw RequestFailException("MemberRepository.signupCheck fail. please check firebaseUuid",
                response.code,response.msg)
        }
        return response.d!!
    }
    ...
    fun getUserInfo(id:String,auth:String) : User {
        ...
        if(!response.isSuccess() && response.d == null){
            throw RequestFailException("MemberRepository.getUserInfo fail. please check id or auth",
                response.code,response.msg)
        }
        return response.d!!
    }
    ...
    fun setBasicProfile(auth:String) : Upload {
        ...
        if(!response.isSuccess() && response.d == null){
            throw RequestFailException("MemberRepository.setBasicProfile fail. please check id or auth",
                response.code,response.msg)
        }
        return response.d!!
    }
    ...
    fun getMyInfo(auth:String) : MyInfo {
        ...
        if(!response.isSuccess() && response.d == null){
            throw RequestFailException("MemberRepository.getMyInfo fail. please check id or auth",
                response.code,response.msg)
        }
        return response.d!!
    }
